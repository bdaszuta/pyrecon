...
@function: Run Sod shock tube and save plot
"""
...
cfg = get_problem("sod", ncells=400, cfl=0.3,
...
out = os.path.join(_REPO, "figs", "profile_sod.png")
os.makedirs(os.path.dirname(out), exist_ok=True)
plot_profile(x, prim, prim_init=prim_init,
             title=f"Sod shock tube, t={cfg.tfinal}, ncells={cfg.ncells}",
             savepath=out)
print(f"Saved {out}")
#
# :D
